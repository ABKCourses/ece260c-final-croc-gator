...
set macro_width 400.0   ;# microns - adjust based on your register file size
set macro_height 400.0  ;# microns
...
set GPL_ARGS {  -density 0.80 }

set GPL2_ARGS { -density 0.80
                -routability_driven
...
repair_antennas -ratio_margin 20 -iterations 3
# check_antennas

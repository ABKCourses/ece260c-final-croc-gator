...
# default from yosys_common.tcl: top_design=core_wrap; sv_flist=../croc.flist
...
#yosys flatten -wb "t:cve2_register_file_ff$*"
...
yosys select -write ${rep_dir}/${top_design}_registers.rpt t:*DFF*
yosys tee -q -o ${rep_dir}/${top_design}reg.rpt  select -list "t:cve2_register_file_ff$*"

...
# Read netlist
read_verilog ../out/timer_unit.v

# Link the design
link_design timer_unit

# Read constraints
read_sdc ../src/constraints.sdc

# Read parasitics if available
if {[file exists ../out/timer_unit.spef]} {
    read_spef ../out/timer_unit.spef
}
...
write_timing_model timer_unit_tt.lib
